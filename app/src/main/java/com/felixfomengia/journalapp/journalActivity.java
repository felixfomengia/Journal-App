...
public class journalActivity extends AppCompatActivity implements ListView.OnItemClickListener, ListView.OnItemLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent launchIntent = new Intent(activity, journalCreate.class);
    ...
    private void loadNotes() {
        ...
        if (cursor == null || cursor.getCount() == 0) {
            Toast.makeText(getBaseContext(), "No Journals Found", Toast.LENGTH_LONG).show();
        } else {
            cursor.moveToFirst();
